...
export const mockConfig = {
  ...
  smoke: {
    ...
    results: [
      ...
      { key: 'publicApiHealth', label: 'Public API /health', url: 'https://scan-api.seoa-nas.com/health', status: 200, ok: true, durationMs: 96 },
      { key: 'publicLanding', label: 'Public landing /', url: 'https://scan-api.seoa-nas.com/', status: 200, ok: true, durationMs: 103 },
      { key: 'publicPrivacy', label: 'Public privacy /privacy', url: 'https://scan-api.seoa-nas.com/privacy', status: 200, ok: true, durationMs: 101 },
      { key: 'publicAppConfig', label: 'Public app-config /v1/app-config', url: 'https://scan-api.seoa-nas.com/v1/app-config', status: 200, ok: true, durationMs: 108 },
      { key: 'adminLogin', label: 'Admin login /login', url: 'https://cartly-admin.seoa-nas.com/login', status: 200, ok: true, durationMs: 94 },
    ],
    history: [
      {
        checkedAt: MOCK_TIMESTAMP,

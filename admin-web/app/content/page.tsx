  ...
  return [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'mySettingsShareEntryAction', label: t('admin.content.fields.mySettingsShareEntryAction', '수정 및 가족공유 진입 버튼') },
        { key: 'mySettingsSharePageTitle', label: t('admin.content.fields.mySettingsSharePageTitle', '수정 및 가족공유 페이지 제목') },
        { key: 'mySettingsSharePageSubtitle', label: t('admin.content.fields.mySettingsSharePageSubtitle', '수정 및 가족공유 페이지 설명'), kind: 'textarea' },
        { key: 'mySettingsShareProfileTitle', label: t('admin.content.fields.mySettingsShareProfileTitle', '기본 정보 섹션 제목') },
        { key: 'mySettingsShareProfileBody', label: t('admin.content.fields.mySettingsShareProfileBody', '기본 정보 섹션 설명'), kind: 'textarea' },
        { key: 'mySettingsShareNicknameFieldLabel', label: t('admin.content.fields.mySettingsShareNicknameFieldLabel', '닉네임 라벨') },
        { key: 'mySettingsShareNicknameFieldHint', label: t('admin.content.fields.mySettingsShareNicknameFieldHint', '닉네임 placeholder') },
        { key: 'mySettingsShareNicknameSaveAction', label: t('admin.content.fields.mySettingsShareNicknameSaveAction', '닉네임 변경 버튼') },
        { key: 'mySettingsShareNicknameSavedMessage', label: t('admin.content.fields.mySettingsShareNicknameSavedMessage', '닉네임 변경 완료 문구') },
        { key: 'mySettingsSharePasswordTitle', label: t('admin.content.fields.mySettingsSharePasswordTitle', '비밀번호 섹션 제목') },
        { key: 'mySettingsSharePasswordBody', label: t('admin.content.fields.mySettingsSharePasswordBody', '비밀번호 섹션 설명'), kind: 'textarea' },
        { key: 'mySettingsSharePasswordUnsupportedBody', label: t('admin.content.fields.mySettingsSharePasswordUnsupportedBody', '비밀번호 수정 불가 안내'), kind: 'textarea' },
        { key: 'mySettingsSharePasswordCodeFieldLabel', label: t('admin.content.fields.mySettingsSharePasswordCodeFieldLabel', '비밀번호 인증 코드 라벨') },
        { key: 'mySettingsSharePasswordCodeSendAction', label: t('admin.content.fields.mySettingsSharePasswordCodeSendAction', '비밀번호 코드 받기 버튼') },
        { key: 'mySettingsSharePasswordCodeSending', label: t('admin.content.fields.mySettingsSharePasswordCodeSending', '비밀번호 코드 전송 중') },
        { key: 'mySettingsSharePasswordCodeSentMessage', label: t('admin.content.fields.mySettingsSharePasswordCodeSentMessage', '비밀번호 코드 발송 완료 문구') },
        { key: 'mySettingsSharePasswordNewFieldLabel', label: t('admin.content.fields.mySettingsSharePasswordNewFieldLabel', '새 비밀번호 라벨') },
        { key: 'mySettingsSharePasswordConfirmFieldLabel', label: t('admin.content.fields.mySettingsSharePasswordConfirmFieldLabel', '비밀번호 확인 라벨') },
        { key: 'mySettingsSharePasswordSaveAction', label: t('admin.content.fields.mySettingsSharePasswordSaveAction', '비밀번호 변경 버튼') },
        { key: 'mySettingsSharePasswordSaving', label: t('admin.content.fields.mySettingsSharePasswordSaving', '비밀번호 저장 중') },
        { key: 'mySettingsSharePasswordSavedMessage', label: t('admin.content.fields.mySettingsSharePasswordSavedMessage', '비밀번호 변경 완료 문구') },
        { key: 'mySettingsShareHouseholdTitle', label: t('admin.content.fields.mySettingsShareHouseholdTitle', '가족공유 섹션 제목') },
        { key: 'mySettingsShareHouseholdEmptyBody', label: t('admin.content.fields.mySettingsShareHouseholdEmptyBody', '가족공유 미참여 설명'), kind: 'textarea' },
        { key: 'mySettingsShareHouseholdJoinedBody', label: t('admin.content.fields.mySettingsShareHouseholdJoinedBody', '가족공유 참여 설명 템플릿'), kind: 'textarea' },
        { key: 'mySettingsShareInviteCodeEmpty', label: t('admin.content.fields.mySettingsShareInviteCodeEmpty', '초대 코드 없음 문구') },
        { key: 'mySettingsShareInviteCodeFieldLabel', label: t('admin.content.fields.mySettingsShareInviteCodeFieldLabel', '초대 코드 라벨') },
        { key: 'mySettingsShareInviteCodeFieldHint', label: t('admin.content.fields.mySettingsShareInviteCodeFieldHint', '초대 코드 placeholder') },
        { key: 'mySettingsShareInviteCodeCreateAction', label: t('admin.content.fields.mySettingsShareInviteCodeCreateAction', '초대 코드 만들기 버튼') },
        { key: 'mySettingsShareInviteCodeRefreshAction', label: t('admin.content.fields.mySettingsShareInviteCodeRefreshAction', '초대 코드 새로고침 버튼') },
        { key: 'mySettingsShareInviteCodeCopyAction', label: t('admin.content.fields.mySettingsShareInviteCodeCopyAction', '초대 코드 복사 버튼') },
        { key: 'mySettingsShareInviteCodeCreatedMessage', label: t('admin.content.fields.mySettingsShareInviteCodeCreatedMessage', '초대 코드 생성 완료 문구') },
        { key: 'mySettingsShareInviteCodeCreatedAndCopiedMessage', label: t('admin.content.fields.mySettingsShareInviteCodeCreatedAndCopiedMessage', '초대 코드 생성+복사 문구') },
        { key: 'mySettingsShareInviteCodeCopiedMessage', label: t('admin.content.fields.mySettingsShareInviteCodeCopiedMessage', '초대 코드 복사 완료 문구') },
        { key: 'mySettingsShareInviteCodeMissingMessage', label: t('admin.content.fields.mySettingsShareInviteCodeMissingMessage', '초대 코드 없음 경고') },
        { key: 'mySettingsShareInviteCodeRequiredMessage', label: t('admin.content.fields.mySettingsShareInviteCodeRequiredMessage', '초대 코드 필수 문구') },
        { key: 'mySettingsShareJoinAction', label: t('admin.content.fields.mySettingsShareJoinAction', '가족공유 참여 버튼') },
        { key: 'mySettingsShareJoinDoneMessage', label: t('admin.content.fields.mySettingsShareJoinDoneMessage', '가족공유 참여 완료 문구') },
        { key: 'mySettingsShareMembersTitle', label: t('admin.content.fields.mySettingsShareMembersTitle', '공유 대상자 제목') },
        { key: 'mySettingsShareOwnerBadge', label: t('admin.content.fields.mySettingsShareOwnerBadge', '가족공유 관리자 배지') },
        { key: 'mySettingsShareMemberBadge', label: t('admin.content.fields.mySettingsShareMemberBadge', '가족공유 구성원 배지') },
        { key: 'mySettingsShareMeBadge', label: t('admin.content.fields.mySettingsShareMeBadge', '가족공유 나 배지') },
        { key: 'mySettingsShareDisbandAction', label: t('admin.content.fields.mySettingsShareDisbandAction', '가족공유 해제 버튼') },
        { key: 'mySettingsShareLeaveAction', label: t('admin.content.fields.mySettingsShareLeaveAction', '가족공유 나가기 버튼') },
        { key: 'mySettingsShareDisbandConfirmTitle', label: t('admin.content.fields.mySettingsShareDisbandConfirmTitle', '가족공유 해제 확인 제목') },
        { key: 'mySettingsShareDisbandConfirmBody', label: t('admin.content.fields.mySettingsShareDisbandConfirmBody', '가족공유 해제 확인 설명'), kind: 'textarea' },
        { key: 'mySettingsShareDisbandConfirmAction', label: t('admin.content.fields.mySettingsShareDisbandConfirmAction', '가족공유 해제 확인 버튼') },
        { key: 'mySettingsShareLeaveConfirmTitle', label: t('admin.content.fields.mySettingsShareLeaveConfirmTitle', '가족공유 나가기 확인 제목') },
        { key: 'mySettingsShareLeaveConfirmBody', label: t('admin.content.fields.mySettingsShareLeaveConfirmBody', '가족공유 나가기 확인 설명'), kind: 'textarea' },
        { key: 'mySettingsShareLeaveConfirmAction', label: t('admin.content.fields.mySettingsShareLeaveConfirmAction', '가족공유 나가기 확인 버튼') },
        { key: 'mySettingsShareDisbandDoneMessage', label: t('admin.content.fields.mySettingsShareDisbandDoneMessage', '가족공유 해제 완료 문구') },
        { key: 'mySettingsShareLeaveDoneMessage', label: t('admin.content.fields.mySettingsShareLeaveDoneMessage', '가족공유 나가기 완료 문구') },
        { key: 'mySettingsShareAccountTitle', label: t('admin.content.fields.mySettingsShareAccountTitle', '계정 마무리 섹션 제목') },
        { key: 'mySettingsShareDeleteAction', label: t('admin.content.fields.mySettingsShareDeleteAction', '탈퇴하기 버튼') },
        { key: 'mySettingsShareDeleteConfirmTitle', label: t('admin.content.fields.mySettingsShareDeleteConfirmTitle', '회원 탈퇴 확인 제목') },
        { key: 'mySettingsShareDeleteConfirmBody', label: t('admin.content.fields.mySettingsShareDeleteConfirmBody', '회원 탈퇴 확인 설명'), kind: 'textarea' },
        { key: 'mySettingsShareDeleteConfirmAction', label: t('admin.content.fields.mySettingsShareDeleteConfirmAction', '회원 탈퇴 확인 버튼') },
        { key: 'mySettingsShareDeleteDoneMessage', label: t('admin.content.fields.mySettingsShareDeleteDoneMessage', '회원 탈퇴 완료 문구') },
        { key: 'mySettingsShareDeleteFailedMessage', label: t('admin.content.fields.mySettingsShareDeleteFailedMessage', '회원 탈퇴 실패 문구'), kind: 'textarea' },
        ...
        { key: 'mySupportEmailLabel', label: t('admin.content.fields.mySupportEmailLabel', '문의 이메일 라벨') },
        { key: 'mySupportEmail', label: t('admin.content.fields.mySupportEmail', '문의 이메일') },

...
class User(Base):
    ...
    last_region_city: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    last_region_district: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    last_region_neighborhood: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    last_region_label: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    last_region_captured_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
...
class Cart(Base):
    ...
    share_with_household: Mapped[bool] = mapped_column(Boolean, default=False)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class CartItem(Base):
    ...
    category_source: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    price: Mapped[int] = mapped_column(Integer)
    quantity: Mapped[int] = mapped_column(Integer, default=1)
...
class AdCampaign(Base):
    ...
    landing_type: Mapped[Optional[str]] = mapped_column(String(40), nullable=True)
    landing_key: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    landing_params_json: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    image_url: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    audience_type: Mapped[str] = mapped_column(String(20), default='all')
    target_region_level: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    target_city: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    target_district: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    target_neighborhood: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
    target_region_keys_json: Mapped[Optional[str]] = mapped_column(Text, nullable=True)

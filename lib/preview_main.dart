...
Map<String, dynamic> _defaultContentSettings() => {
  ...
  'savedEmptyBody': '홈에서 카트를 저장하면 다음 장보기 전에 다시 꺼내볼 수 있어요.',
  'recentSavedTitle': '최근 저장한 카트',
  'recentSavedEmptyBody': '아직 저장한 카트가 없어요. 카트를 저장해두면 다음 장보기 전에 바로 이어볼 수 있어요.',
  ...
  'homeExploreEntryBody': '담은 상품, 고민한 상품, 자주 사는 상품까지 모아 더 나은 선택을 도와드려요.',
...
Map<String, dynamic> _buildPreviewCopy(Map<String, dynamic> form) {
  ...
  return {
    'home': {
      ...
      'exploreEntryTitle': text('homeExploreEntryTitle', '비교 이어보기'),
    ...
    'saved': {
      ...
      'subtitle': text('savedSubtitle', '지난 장보기를 다시 꺼내 보고, 다음 선택까지 이어가보세요.'),
      'recentTitle': text('recentSavedTitle', '최근 저장 카트'),
      'emptyTitle': text('savedEmptyTitle', '아직 저장된 카트가 없어요'),
      'emptyBody': text('savedEmptyBody', '홈에서 카트를 저장하면 다음 장보기 전에 다시 꺼내볼 수 있어요.'),
      'recentEmptyBody': text(
        'recentSavedEmptyBody',
        '아직 저장한 카트가 없어요. 카트를 저장해두면 다음 장보기 전에 바로 이어볼 수 있어요.',
      ),
      'adFallbackTitle': text('savedAdFallbackTitle', '이 카트와 잘 맞는 혜택'),
    ...
    'my': {
      ...
      'benefitsTitle': text('myBenefitsTitle', '계정을 연결하면 장보기가 이어져요'),
      'benefitsBody': text(
        'myBenefitsBody',
        '• 지난 카트를 계속 볼 수 있어요\n• 최근 스캔과 비교 흐름을 이어갈 수 있어요\n• 다음 장보기 전에 자주 사는 상품을 다시 살펴볼 수 있어요',
      ),
      ...
      'adFallbackTitle': text('myAdFallbackTitle', '회원 맞춤 혜택 준비 중'),
      'adFallbackMessage': text(
        'myAdFallbackMessage',
        '마이에서는 계정 흐름에 맞는 혜택만 보여드릴게요.',
      ),
    ...
    'login': {
      ...
      'subtitle': text('loginSubtitle', '저장한 카트와 스캔 흐름을 이어서 보시려면 로그인해 주세요.'),
      'benefitsTitle': text('loginBenefitsTitle', '로그인하면 장보기가 이어져요'),
      'benefitsBody': text(
        'loginBenefitsBody',
    ...
    'saveComplete': {
      ...
      'subtitle': text('saveCompleteSubtitle', '다음 장보기 때 다시 이어볼 수 있어요.'),
      'adFallbackTitle': text('saveCompleteAdFallbackTitle', '이어서 비교하기'),
      'adFallbackMessage': text(

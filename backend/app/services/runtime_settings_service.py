    ...
    'myPageCategoryGroups': [
        {
            'id': 'food',
            'label': '식품',
            'keywords': ['우유', '계란', '바나나', '사과', '양파', '대파', '샐러드', '요거트', '과일', '채소', '당근', '청경채', '애호박', '쌀', '라면', '빵', '베이글', '과자', '쿠키', '초콜릿', '아이스크림', '시리얼', '주스', '커피', '물', '음료', '제로', '닭가슴살', '닭다리', '동물복지', '연어', '소고기', '돼지고기', '두부', '토마토', '찰토마토', '비엔나', '소시지', '홈런', '홈런볼', '매일', '상하목장', '오뚜기', '동원', '해태', '크라운'],
        },
        {
            'id': 'life_health',
            'label': '생활/건강',
        ...
        },
        {
            'id': 'digital',
            'label': '디지털/가전',
            'keywords': ['이어폰', '헤드폰', '충전기', '케이블', '마우스', '키보드', '모니터', '노트북', '아이폰', '갤럭시', '가전', '청소기', '건전지', '배터리'],
        },
        {
            'id': 'fashion_clothes',
            'label': '패션의류',
        ...
        },
        {
            'id': 'furniture',
            'label': '가구/인테리어',
            'keywords': ['의자', '책상', '선반', '수납', '조명', '침구', '이불', '베개', '커튼', 'led', '다운라이트', '전등', '등기구'],
        },
        {
            'id': 'baby',
            'label': '출산/육아',
            'keywords': ['기저귀', '분유', '물티슈', '유아', '아기', '젖병', '이유식', '키즈'],
        },
        {
            'id': 'sports',
            'label': '스포츠/레저',
            'keywords': ['요가', '덤벨', '텐트', '캠핑', '자전거', '축구', '농구', '러닝', '등산', '쉐이드', '랜턴', 'kovea', 'coleman'],
        },
        {
            'id': 'leisure',
            'label': '여가/생활편의',
            'keywords': ['티켓', '쿠폰', '도서', '책', '문구', '반려동물', '사료', '여행', '공연', '베베핀', '버블'],
        },
    ],
}

...
export const mockContentSettings = {
  ...
  myComplianceTitle: '개인정보 및 문의',
  myComplianceBody: '개인정보 처리방침과 고객센터 연락 채널을 여기서 바로 확인하실 수 있어요.',
  myPrivacyPolicyLabel: '개인정보 처리방침',
  myPrivacyPolicyUrl: 'https://scan-api.seoa-nas.com/privacy',
  mySupportEmailLabel: '고객센터 이메일',
  mySupportEmail: '',
  ...
  myBusinessInfo: '',
  mySupportNote: '운영 연락처와 사업자/운영 정보는 admin에서 바로 수정할 수 있어요.',
  ...
  publicSitePrivacyIntro: 'Cartly는 사용자가 직접 추가하거나 스캔한 장보기 상품 정보를 바탕으로 현재 카트, 저장된 장보기 기록, 그리고 같은 구매 의도를 유지하는 대체안 탐색 흐름을 제공합니다.',

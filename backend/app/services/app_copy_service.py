...
DEFAULT_APP_COPY: Dict[str, Any] = {
    ...
    'my': {
        ...
        'settingsShareHouseholdJoinedBody': '{householdName} · {memberCount}명과 저장 카트를 함께 보고 있어요',
        ...
        'supportEmail': 'scancart.wimc@gmail.com',
    ...
    'publicSite': {
        ...
        'privacyIntro': 'Cartly는 사용자가 직접 추가하거나 스캔한 장보기 상품 정보와, 앱 실행 중 확인한 현재 위치 또는 대략적 지역 정보를 바탕으로 현재 카트, 저장된 장보기 기록, 근처 마트 할인정보 확인, 그리고 같은 구매 의도를 유지하는 대체안 탐색 흐름을 제공합니다.',

...
_NAVER_LARGE_CATEGORY_RULES: list[tuple[str, tuple[str, ...]]] = [
    ('출산/육아', ('기저귀', '물티슈', '분유', '젖병', '유아', '아기', '신생아', '이유식', '유모차', '카시트', '아기띠', '키즈', '유아용')),
    ('식품', ('쌀', '떡', '라면', '과자', '스낵', '쿠키', '비스킷', '크래커', '쿠쿠다스', '새우깡', '오잉', '홈런', '홈런볼', '음료', '생수', '커피', '우유', '요거트', '치즈', '계란', '달걀', '닭가슴살', '닭다리', '동물복지', '고기', '소고기', '돼지고기', '과일', '바나나', '채소', '당근', '청경채', '애호박', '토마토', '찰토마토', '오이', '김치', '반찬', '장아찌', '소스', '마요', '마요네스', '오트', '오트밀', '오일', '식용유', '올리브유', '참기름', '들기름', '시리얼', '간식', '빵', '베이커리', '크루아상', '냉동', '만두', '햄', '소시지', '비엔나', '참치', '캔', '곡물', '견과', '비타민젤리', '프로틴바', '카레', '매일', '상하목장', '오뚜기', '동원', '해태', '크라운', '1/2')),
    ('생활/건강', ('세제', '휴지', '화장지', '티슈', '샴푸', '린스', '바디워시', '비누', '칫솔', '치약', '면도기', '마스크', '건강식품', '영양제', '비타민', '오메가', '프로바이오틱스', '생리대', '청소', '수세미', '주방세제', '섬유유연제', '캡슐세제', '주방', '생활용품', '건강')),
    ('디지털/가전', ('아이폰', '갤럭시', '아이패드', '맥북', '노트북', '모니터', '키보드', '마우스', '이어폰', '헤드폰', '에어팟', '충전기', '케이블', '닌텐도', '플레이스테이션', '게임기', 'tv', '티비', '냉장고', '세탁기', '청소기', '전자레인지', '가전', '휴대폰', '스마트폰', '건전지', '배터리')),
    ...
    ('스포츠/레저', ('텐트', '캠핑', '랜턴', '쉐이드', '아이스박스', '침낭', '타프', '골프', '축구', '야구', '농구', '러닝', '헬스', '요가', '자전거', '등산', '낚시', '수영', '운동', '레저', 'kovea', 'coleman')),
    ('가구/인테리어', ('의자', '책상', '테이블', '소파', '침대', '매트리스', '서랍', '수납', '선반', '조명', '스탠드', '거울', '커튼', '카펫', '인테리어', '가구', 'led', '다운라이트', '전등', '등기구')),
    ('문구/사무용품', ('노트', '공책', '펜', '볼펜', '연필', '캘린더', '다이어리', '파일', '프린터', '복사용지', '문구', '사무용품')),
    ('완구/취미', ('레고', '피규어', '보드게임', '퍼즐', '포켓몬카드', '장난감', '완구', '프라모델', '취미', '베베핀', '버블', '비눗방울')),
